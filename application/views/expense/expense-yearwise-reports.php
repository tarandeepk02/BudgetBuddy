...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <div class="col-12">
      <h1 class="page-header">Yearly Expense Report</h1>
    </div>
  </div>
  <!--/.row-->
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12"> <?php echo form_open('expense/yearwiserport',['name'=>'expensedqtewiserportds'])?>
            <div class="row">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <h5 align="center" style="color:blue">Yearwise Expense Report from <?php echo $fromdate;?> to <?php echo $todate;?></h5>
        <div class="panel-body">
          <div class="col-md-12">
